...
class Statistics(object):
    ...
    * Accuracy
    ...
    def f1_prec_recall(self):
        prec = self.precision()
        recall = self.recall()
        return 2 * prec * recall / max(prec + recall, 1), prec, recall
...
class Runner(object):
    ...
    def _run_for_eval(run_type,
        ...
        if return_predictions:
            ...
            return cum_stats.f1_prec_recall()
    ...
    def eval(model, dataset, **kwargs):
        ...
        """
        return Runner._run_for_eval('EVAL', model, dataset, **kwargs)
